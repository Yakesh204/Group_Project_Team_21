...
public class MovementManager : MonoBehaviour
{
    ...
    // Events
    public static event Action<float> StaminaUpdated;
    ...
    private void OnDisable() {
        ...
        Movement_canceled(new InputAction.CallbackContext());
    }
    ...
    private void Update() {
        ...
        if (_moveDirection.magnitude >= 0.1f && !_aimManager.IsADS && !_firearmManager.ShootPressed) {
        ...
        } else if (_aimManager.IsADS || _firearmManager.ShootPressed) {
    ...
    private void LateUpdate() {
        ...
        if ((!_isSprinting || !_isMoving) && _staminaCurrent < _staminaMax) {
            ...
            StaminaUpdated?.Invoke(_staminaCurrent / _staminaMax);
        }
